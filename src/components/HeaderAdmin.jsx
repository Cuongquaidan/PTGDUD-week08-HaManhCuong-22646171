  ...
  return (
    <div>
        ...
        <div className='relative '>
            <img src={Search} alt="" className='absolute left-2 top-1/2 transform -translate-y-1/2'/>
            <input type="text" className='p-1 px-10 bg-neutral-200 outline-none'  placeholder='Search...'/>
        </div>
            <div>
        ...
        <div className='py-8 px-6'>
                ...
                <div className='mt-5 grid grid-cols-3 gap-4'>
                    ...
                    <div className='absolute top-5 right-5 w-11 h-11 border rounded-md flex items-center justify-center border-[#F44B87FF]'>
                       <LuShoppingCart size={20} className='text-primary'></LuShoppingCart>
                    </div>
                    <p className='font-bold text-md'>Turnover</p>
                <p className='font-bold text-4xl'>$92,405</p>
                <div className='flex text-sm items-center gap-2 '>
                <IoTriangle size={8} className='text-[#117B34FF]'/>
                <p className=' text-[#117B34FF]'>5.39%</p>
                <p className='text-neutral-600'>period of change</p>
                </div>
                    </div>
                    ...
                    <div className='absolute top-5 right-5 w-11 h-11 border rounded-md flex items-center justify-center border-[#2B80FFFF]'>
                       <IoLogoUsd size={20} className='text-[#2B80FFFF]'></IoLogoUsd>
                    </div>
                    <p className='font-bold text-md'>Profit</p>
                <p className='font-bold text-4xl'>$32,218</p>
                <div className='flex text-sm items-center gap-2 '>
                <IoTriangle size={8} className='text-[#117B34FF]'/>
                <p className=' text-[#117B34FF]'>5.39%</p>
                <p className='text-neutral-600'>period of change</p>
                    ...
                    <div className='rounded-md bg-[#F0F6FFFF] p-5 relative flex flex-col gap-4'> 
                    <div className='absolute top-5 right-5 w-11 h-11 border rounded-md flex items-center justify-center border-[#2B80FFFF]'>
                       <FaRegUserCircle size={20} className='text-[#2B80FFFF]'></FaRegUserCircle>
                    </div>
                    <p className='font-bold text-md'>New customer</p>
                <p className='font-bold text-4xl'>298</p>
                <div className='flex text-sm items-center gap-2 '>
                <IoTriangle size={8} className='text-[#117B34FF]'/>
                <p className=' text-[#117B34FF]'>6.84%</p>
                <p className='text-neutral-600'>period of change</p>
                </div>
                    </div>
